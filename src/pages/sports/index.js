            ...
            <Layout>
                <div className="lg:px-16 md:px-8 px-4 pt-16">
                    <p className='flex items-center text-lg mb-6 uppercase font-medium text-cyan-600'>
                        Sports{" "}
                        <span
                            className='text-xs rounded-full p-0.5 px-2 border border-cyan-500 bg-cyan-100 text-cyan-600 ml-4'>
                    {team}
                </span>{" "}
                        <span
                            className='text-xs rounded-full p-0.5 px-2 border border-cyan-500 bg-cyan-100 text-cyan-600 ml-2'>
                    {content}
                </span>
                    </p>
                    <div className="flex items-start w-full">
                        <div className='w-full mr-4'>
                            ...
                            <Link href={`/sports/post/baseball-and-softball-tryouts-coming-up`}>
                                <div
                                    className='hover:scale-[1.03] hover:shadow-md transition border border-slate-300 rounded w-[400px] shadow shadow-slate-100'>
                                    <img
                                    ...
                                    <div className='p-2 pb-3'>
                                        ...
                                        <div className='my-2 flex items-center'>
                                            <div
                                                className='border border-red-500 bg-red-100 w-fit px-2 py-0.5 rounded-full font-medium text-red-600'>Baseball
                                            </div>
                                            <div
                                                className='ml-2 border border-cyan-500 bg-cyan-100 w-fit px-2 py-0.5 rounded-full font-medium text-cyan-600'>News
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='mt-4 border border-slate-300 rounded w-[400px] shadow shadow-slate-100'>
                                <img src='https://trackandturf.com/wp-content/uploads/2020/04/about-image.jpg'
                                     className='w-full h-[100px] rounded-t object-cover border-white'/>
                                <div className='p-2 pb-3'>
                                    <p className='text-sm uppercase font-medium text-slate-400'>March 18, 2023</p>
                            ...
                            <div className='mt-4 border border-slate-300 rounded w-[400px] shadow shadow-slate-100'>
                                <img src='https://img.youtube.com/vi/7Aj2TKDJF-s/hqdefault.jpg'
                                     className='w-full h-[100px] rounded-t object-cover border-white'/>
                                <div className='p-2 pb-3'>
                                    ...
                                    <div className='my-2 flex items-center'>
                                        ...
                                        <div
                                            className='ml-2 border border-cyan-500 bg-cyan-100 w-fit px-2 py-0.5 rounded-full font-medium text-cyan-600'>Match
                                            replays
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            className="pb-4 flex-col shadow-[0px_4px_0px_0px_#06b6d490] lg:flex md:flex hidden ml-auto border border-cyan-500 rounded p-2 w-[400px]">
                            ...
                            <div className="">
                                ...
                                <Tippy
                                    content={
                                        <div className="min-w-[200px] flex flex-col">
                                            {teams.map(x => {
                                                return <div onClick={() => setTeam(x)}
                                                            className={`select-none transition flex items-center hover:cursor-pointer p-2 ${teams.indexOf(x) !== teams.length - 1 && 'border-b'} ${team === x ? 'bg-cyan-50 text-cyan-600' : 'odd:bg-white even:bg-slate-100 border-slate-300'}`}
                                                            id={teams.indexOf(x)}>
                                                    {x} <FontAwesomeIcon icon={team === x ? faCircleSolid : faCircle}
                                ...
                                >
                                    <div
                                        className="transition border border-slate-300 bg-slate-100 hover:cursor-pointer hover:border-slate-400 hover:bg-slate-200/80 select-none rounded p-1 py-0.5 w-fit">
                                        {team}
                                        <FontAwesomeIcon
                                            icon={faAngleDown}
                                ...
                                <Tippy
                                    content={
                                        <div className="min-w-[200px] flex flex-col">
                                            {contents.map(x => {
                                                return <div onClick={() => setContent(x)}
                                                            className={`select-none transition flex items-center hover:cursor-pointer p-2 ${contents.indexOf(x) !== contents.length - 1 && 'border-b'} ${content === x ? 'bg-cyan-50 text-cyan-600' : 'odd:bg-white even:bg-slate-100 border-slate-300'}`}
                                                            id={contents.indexOf(x)}>
                                                    {x} <FontAwesomeIcon icon={content === x ? faCircleSolid : faCircle}
                                                                         className='transition ml-auto'/>
                                                </div>
                                            })}
                                        </div>
