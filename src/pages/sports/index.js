                 ...
                 />
                      ...
                      Baseball and softball tryouts coming up
                                        ...
                                        <div className="my-2 flex items-center">
                                            <div
                                                className="border border-red-500 bg-red-100 w-fit px-2 py-0.5 rounded-full font-medium text-red-600">
                        Baseball
                                            
                      </div>
                                            <div
                                                className="ml-2 border border-cyan-500 bg-cyan-100 w-fit px-2 py-0.5 rounded-full font-medium text-cyan-600">
                        News
               ...
               />
                    ...
                    Track scheduled to start soon
                                    ...
                                    <div className="my-2 flex items-center">
                                        ...
                                        <div
                                            className="border border-purple-500 bg-purple-100 w-fit px-2 py-0.5 rounded-full font-medium text-purple-600">
                      Track
              ...
              <Surveys />
               ...
               />
                    ...
                    Woodrow Wilson v. John Adams: 27-39
                                    ...
                                    <div className="my-2 flex items-center">
                                        <div
                                            className="border border-orange-500 bg-orange-100 w-fit px-2 py-0.5 rounded-full font-medium text-orange-600">
                      Basketball
