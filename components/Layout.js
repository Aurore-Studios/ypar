...
export default function Layout({ children, home }) {
  ...
  return (
    <div>
      ...
      <div className={`w-full sticky top-0 min-h-screen`}>
        <div className="flex items-center hover:cursor-default w-full bg-pink-100 py-3 lg:px-16 md:px-8 px-4 border-b-2 border-pink-500">
          <Link href="/">
            <img
              ...
              alt="logo"
              width="120"
              className="mr-1 rounded border border-pink-500 hover:scale-[1.05] transition hover:cursor-pointer hover:shadow-lg hover:shadow-pink-200 select-none"
            />
          </Link>
          {Object.keys(links).map((x) => {
            return (
              <Link
                href={links[x]}
                key={x}
                className="font-medium ml-4 text-xl text-pink-500 hover:text-pink-700 transition"
              >
                {x}
              </Link>
            );
          ...
          <div className="ml-auto flex items-center">
            <Link
              href="/login"
              className="font-medium text-xl text-pink-500 hover:text-pink-700 transition"
            >
              Login
            </Link>
        ...
        <div className="py-8 lg:px-16 md:px-8 px-4 w-full border-t border-slate-300 mt-16">
          <div className="flex flex-wrap">
            ...
            <div className="ml-8 flex flex-wrap">
              <div className="text-zinc-400">
                <p className="text-zinc-500 font-medium">Miscellaneous</p>
