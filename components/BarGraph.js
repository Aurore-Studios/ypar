...
export default function BarGraph() {
  return (
    <div className="w-[400px] flex flex-col items-center border border-slate-300 max-w-screen-md  pb-6 bg-white rounded mt-4 shadow sm:pr-20 sm:pl-20 sm:pt-5">
      <h2 className="text-xl font-bold">MVP of Game</h2>
      <span className="text-sm font-medium text-gray-500">3/1/22</span>
